...
class GUIRemoteControlCommands(object):
    ...
    COMMAND_STR = "$"
    # BASIC
    START = COMMAND_STR + "SRT"
    PAUSE = COMMAND_STR + "PSE"
    PING = COMMAND_STR + "PNG"
    QUIT  = COMMAND_STR + "QUT"
    #getter
    GET_FX1 = COMMAND_STR + "gFX1"
    GET_FX2 = COMMAND_STR + "gFX2"
    GET_FY1 = COMMAND_STR + "gFY1"
    GET_FY2 = COMMAND_STR + "gFY2"
    GET_FZ1 = COMMAND_STR + "gFZ1"
    GET_FZ2 = COMMAND_STR + "gFZ2"
    GET_TX1 = COMMAND_STR + "gTX1"
    GET_TX2 = COMMAND_STR + "gTX2"
    GET_TY1 = COMMAND_STR + "gTY1"
    GET_TY2 = COMMAND_STR + "gTY2"
    GET_TZ1 = COMMAND_STR + "gTZ1"
    GET_TZ2 = COMMAND_STR + "gTZ2"
    GET_THRESHOLD_LEVEL =COMMAND_STR + "gTL"
    GET_THRESHOLD_LEVEL2 = COMMAND_STR + "gTL2"
    GET_VERSION = COMMAND_STR + "gVR"
    # setter
    FILENAME = COMMAND_STR + "sFN"
    SET_THRESHOLDS = COMMAND_STR + "sTH"
    SET_LEVEL_CHANGE_DETECTION = COMMAND_STR + "sCD1"
    SET_LEVEL_CHANGE_DETECTION2 = COMMAND_STR + "sCD2"
    SET_RESPONSE_MINMAX_DETECTION = COMMAND_STR + "sMD1"
    SET_RESPONSE_MINMAX_DETECTION2 = COMMAND_STR + "sMD2"
    #feedback
    FEEDBACK = COMMAND_STR + "xFB"
    VALUE = COMMAND_STR + "xVL"
    RESPONSE_MINMAX = COMMAND_STR + "xRM1"
    RESPONSE_MINMAX2 = COMMAND_STR + "xRM2"
    CHANGED_LEVEL = COMMAND_STR + "xCL1"
    CHANGED_LEVEL2 = COMMAND_STR + "xCL2"
